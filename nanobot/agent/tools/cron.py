        ...
        return {
            ...
            "properties": {
                ...
                "at": {
                    "type": "string",
                    "description": (
                        "One-time execution time. Use relative (e.g. 'in 5 minutes', 'in 2 hours', 'in 1 day') "
                        f"or ISO datetime (e.g. '2026-02-12T10:30:00'). Naive values default to {self._default_timezone}."
                    ),
                },
